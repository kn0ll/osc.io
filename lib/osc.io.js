...
module.exports = function(io, init_opts) {

  // accept init opts to set logging to false
  // this will make all send receive not show up.
  // the create server and client logs still show
  if(!init_opts){
    var init_opts = {};
    init_opts.log = true;
  }
